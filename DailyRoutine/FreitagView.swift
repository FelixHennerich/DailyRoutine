...
struct FreitagView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle("Freitag - Routine")
            .navigationBarItems(trailing: EditButton())
        }
        .sheet(isPresented: $isAddingNewItem, content: {
            AddNewItemViewFreitagView(items: $items, isPresented: $isAddingNewItem)
        })
    }
...
struct FreitagView_Previews: PreviewProvider {
    static var previews: some View {
        FreitagView()
    }
}

struct AddNewItemViewFreitagView: View {
