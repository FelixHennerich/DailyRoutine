...
struct MittwochView: View {
    @State private var items: [Item] = [
        Item(name: "Wakeup xx:xx"),
        Item(name: "Fahrrad 15mins"),
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle("Mittwoch - Routine")
            .navigationBarItems(trailing: EditButton())
        }
        .sheet(isPresented: $isAddingNewItem, content: {
            AddNewItemViewMittwochView(items: $items, isPresented: $isAddingNewItem)
        })
    }
...
struct MittwochView_Previews: PreviewProvider {
    static var previews: some View {
        MittwochView()
    }
}

struct AddNewItemViewMittwochView: View {
