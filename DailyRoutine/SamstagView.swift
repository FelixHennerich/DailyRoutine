...
struct SamstagView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle("Samstag - Routine")
            .navigationBarItems(trailing: EditButton())
        }
        .sheet(isPresented: $isAddingNewItem, content: {
            AddNewItemViewSamstagView(items: $items, isPresented: $isAddingNewItem)
        })
    }
...
struct SamstagView_Previews: PreviewProvider {
    static var previews: some View {
        SamstagView()
    }
}

struct AddNewItemViewSamstagView: View {
